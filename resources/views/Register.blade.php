    ...
    <div class="nav">
      ...
      <div class="menu-links">
        <ul>
          ...
          <li><a href="/login" style="text-decoration: none; color: inherit;">log In.</a></li>
...
<form action="register"method="POST" class="form">
            ...
            <div class="name_container">
               ...
               <label class="lbl-nombre"><span class="text-nomb">Name</span></label>
            </div>
      ...
      <div class="btn">
        <button class="button-23" type="submit" >Register</button>
      </div>
</form>
